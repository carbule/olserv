package cn.azhicloud.task.service.impl.autotask;

import java.util.List;

import cn.azhicloud.task.constant.TaskTypeConst;
import cn.azhicloud.task.repository.AutoTaskRepository;
import cn.azhicloud.task.repository.mapper.AutoTaskMapper;
import cn.azhicloud.task.service.AutoTaskExecuteService;
import cn.azhicloud.task.service.impl.autotask.bo.TaskHKP1003BO;
